...
class TradersOfficeDealingPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\TradersOfficeDealing  $tradersOfficeDealing
     * @return mixed
     */
    public function update(User $user, TradersOfficeDealing $tradersOfficeDealing)
    {
        //
    }
     ...
     * @return mixed
     */
    public function delete(User $user, TradersOfficeDealing $tradersOfficeDealing)
    {
        //
    }
     ...
     * @return mixed
     */
    public function restore(User $user, TradersOfficeDealing $tradersOfficeDealing)
    {
        //
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, TradersOfficeDealing $tradersOfficeDealing)
    {
        //
    }
}
